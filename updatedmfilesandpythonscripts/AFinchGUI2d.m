function varargout = AFinchGUI2d(varargin)
% AFINCHGUI2d MATLAB code for AFinchGUI2d.fig
%      AFINCHGUI2D, by itself, creates a new AFINCHGUI2D or raises the existing
%      singleton*.
%
%      H = AFINCHGUI2D returns the handle to a new AFINCHGUI2D or the handle to
%      the existing singleton*.
%
%      AFINCHGUI2D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AFINCHGUI2D.M with the given input arguments.
%
%      AFINCHGUI2D('Property','Value',...) creates a new AFINCHGUI2D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before AFinchGUI2d_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to AFinchGUI2d_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help AFinchGUI2d

% Last Modified by GUIDE v2.5 20-May-2014 12:18:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AFinchGUI2d_OpeningFcn, ...
                   'gui_OutputFcn',  @AFinchGUI2d_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AFinchGUI2d is made visible.
function AFinchGUI2d_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to AFinchGUI2d (see VARARGIN)

% Choose default command line output for AFinchGUI2d
...
% UIWAIT makes AFinchGUI2d wait for user response (see UIRESUME)
...
function varargout = AFinchGUI2d_OutputFcn(hObject, eventdata, handles) 
